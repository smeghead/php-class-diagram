...
EOJ;
    ...
    public function testInitialize(): void {
        ...
        $this->assertSame('Product', $product->entries[0]->class->getClassType()->getName(), 'product class name');
        $this->assertSame('Price', $product->entries[1]->class->getClassType()->getName(), 'price class name');
        $this->assertSame('Name', $product->entries[2]->class->getClassType()->getName(), 'name class name');
